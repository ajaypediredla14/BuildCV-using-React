...
class Form extends Component {
  ...
  handleSubmit = (event) => {
    ...
    axios
      .post("http://127.0.0.1:8000/resume/", data, {
  ...
  render() {
    return (
      <React.Fragment>
        <Grid container className="section mb_20 pt_45">
          <Grid item className="section_title mb_10">
            <span></span>
            <Typography className="section_title_text">About me</Typography>
          </Grid>
          <Grid item xs={12}>
            {resumeData.about.map((about,index)=>(
            <Typography key={index} variant="body2" className="aboutme_text">
              {about}
            </Typography>
            ))}
          </Grid>
          ...
          <Grid item xs={12}>
            <Grid container className="resume_Timeline">
              <Grid item sm={12} md={6}>
                <CustTimeline icon={<WorkIcon />} title="Experience">
